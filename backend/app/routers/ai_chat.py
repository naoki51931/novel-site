...
async def ai_chat_next_user_lines(
    ...
    req_model = _parse_payload(AIChatNextLineSuggestRequest, req)
...
async def ai_chat_generate_image(
    ...
    req_model = _parse_payload(AIChatImageGenerateRequest, req)
...
async def ai_chat_auto_continue(
    ...
    req_model = _parse_payload(AIChatAutoContinueRequest, req)
...
async def augment_ai_chat_character(
    ...
    req_model = _parse_payload(AIChatCharacterAugmentRequest, req)
...
async def ai_chat_character_anime_title_candidates(
    ...
    req_model = _parse_payload(AIChatAnimeTitleCandidatesRequest, req)
...
def create_ai_chat_character(
    ...
    payload_model = _parse_payload(AIChatCharacterCreateRequest, payload)
...
def update_ai_chat_character(
    ...
    payload_model = _parse_payload(AIChatCharacterUpdateRequest, payload)
...
def publish_ai_chat_character(
    ...
    payload_model = _parse_payload(AIChatPublishRequest, payload)
...
def import_ai_chat_messages(
    ...
    payload_model = _parse_payload(AIChatMessageImportRequest, payload)
