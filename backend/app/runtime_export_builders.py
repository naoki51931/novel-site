...
def build_auth_runtime_exports(
    *,
    ...
    premium_plan_usage_multiplier_for_user_impl,
    ...
    _ai_chat_allowed_tokens = partial(
        ...
        premium_plan_usage_multiplier_for_user=premium_plan_usage_multiplier_for_user,
