...
def update_novel(
    ...
    payload_model = _parse_payload(legacy.NovelUpdate, payload)
...
def get_comments(
    ...
    from .. import main as legacy
    return legacy.get_comments(novel_id=novel_id, request=request, db=db)
...
def post_comment(
    ...
    from .. import main as legacy
    return legacy.post_comment(novel_id=novel_id, payload=payload, request=request, db=db)
...
def create_episode(
    ...
    from .. import main as legacy
    payload_model = _parse_payload(legacy.EpisodeCreate, payload)
...
def delete_comment(
    ...
    from .. import main as legacy
    return legacy.delete_comment(novel_id=novel_id, comment_id=comment_id, request=request, db=db)
