...
def update_profile(
    ...
    from .. import main as legacy
    payload_model = _parse_payload(legacy.ProfileUpdate, payload)
...
def follow_user(
    ...
    from .. import main as legacy
    return legacy.follow_user(user_id=user_id, request=request, db=db)
...
def unfollow_user(
    ...
    from .. import main as legacy
    return legacy.unfollow_user(user_id=user_id, request=request, db=db)
...
def get_follow_status(
    ...
    from .. import main as legacy
    return legacy.get_follow_status(user_id=user_id, request=request, db=db)
...
def list_followers(
    ...
    from .. import main as legacy
    return legacy.list_followers(user_id=user_id, request=request, db=db, limit=limit, offset=offset)
...
def list_following(
    ...
    from .. import main as legacy
    return legacy.list_following(user_id=user_id, request=request, db=db, limit=limit, offset=offset)
